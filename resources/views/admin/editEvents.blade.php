...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <form action="{{ route('admin.event.update', $event->id) }}" enctype="multipart/form-data" method="POST" class="card"
                autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('event_type') is-invalid @enderror"  name="event_type">
                                    ...
                                    <option value="{{ $item}}" {{ $item == $event->event_type ? 'selected' : ''}}>{{$label }}</option>
                                    @endforeach
                    ...
                    <div class="g-3">
                        <div class="mb-3">
                            ...
                            <textarea value="{{ old('description') }}"  class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Description">{{old('description' , $event->description)}}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row g-3">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror"  name="status">
                                    ...
                                    <option value="{{ $item}}" {{ $item == $event->status ? 'selected' : ''}}>{{$label }}</option>
                                    @endforeach
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="time" name="time" value="{{ old('date' , $event->time) }}"
